...
class Users(models.Model):
    ...
    def toDict(self):
        return {'id':self.id,'username':self.username,'name':self.name,'sex':str(self.sex),'code':self.code,'password':self.password,'address':self.address,'phone':self.phone,'email':self.email,'state':self.state}
